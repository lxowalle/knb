...
// pj_status_t _pjsua_app_destroy(void)
// {
//     pj_status_t status;
...
// {
//     pj_status_t res = PJ_TRUE;

//     pj_bzero(&cfg, sizeof(cfg));
//     cfg.on_started = on_started;
//     cfg.on_stopped = on_stopped;
//     cfg.on_config_init = on_config_init;
//     cfg.argc = 1;
//     cfg.argv = NULL;

//     res = _pjsua_app_init(&cfg);
//     if (res != PJ_SUCCESS)
//     {
//         return res;
//     }
...
int mf_pjsip_init(void)
{
	...
	{
		pj_thread_register("pj_thread", thread_desc, &pthread);
	}
